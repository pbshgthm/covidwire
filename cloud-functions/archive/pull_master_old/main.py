	...
	for state in state_list:
		...
		for record in all_records:
			...
			if status=="Completed":
				...
				#iterate through lang for multi language
				db_fields['digests'][lang]={
					'digest':record['fields']['Digest Translation'],
					'headline':record['fields']['Headline Translation']
				}
		...
		db_root.child(state).set(date_dict)
