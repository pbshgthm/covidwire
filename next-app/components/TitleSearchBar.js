	...
	return(
		<React.Fragment>
			<div className="TitleBarSearchPanel">
				<img onClick={(e)=>{e.stopPropagation();props.setShowSearch(false)}} className={"TitleBack"} src="/assets/back.png" alt="Close"/>
				...
				<img className={"TitleBarSearchBtn"} src="/assets/search.png" alt="Search" onClick={()=>handleSumbit()}/>
